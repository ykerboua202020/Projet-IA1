...
if menu == 'Accueil':
    st.write("Lien GitHub du projet: https://github.com/ykerboua202020/Projet-IA1.git")
    ...
    st.write("""
            ...
            L’analyse descriptive a permis de résumer les caractéristiques des principales variables. Par exemple, la concentration moyenne en PM2.5 est d’environ 18.02 µg/m³, avec une médiane de 12 µg/m³ et un écart-type de 17.23, tandis que la concentration en PM10 présente une moyenne de 28.22 µg/m³, une médiane de 21.7 µg/m³, et un écart-type de 20.61. Les quartiles du monoxyde de carbone (CO) se situent entre 1,03 ppm (Q1) et 1,84 ppm (Q3), indiquant une distribution relativement homogène autour de la médiane.
             
            L’analyse de corrélation révèle que les polluants atmosphériques CO et NO2, ainsi que la température sont les principaux contributeurs à la dégradation de la qualité de l’air. Ces variables présentent des coefficients de corrélation élevés avec la variable cible, indiquant que leur augmentation est directement associée à une détérioration de la qualité de l'air. La température et la densité de population jouent également un rôle notable dans l'augmentation des niveaux de pollution, tandis que la variable proximité des zones industrielles présente une corrélation négative avec la qualité de l’air, ce qui signifie que plus une zone est éloignée des sites industriels, meilleure est la qualité de l’air
